  ...
  return [
    {
      ...
      description: `${wastedTerms.length} search terms have received 50+ clicks with zero purchases. Adding these as negative keywords will stop budget waste and improve overall ACOS. Total wasted: ₹${Math.round(totalWasted).toLocaleString('en-IN')}.`,
