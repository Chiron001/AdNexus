  ...
  for (const insight of insights) {
    ...
    if (spend > 10000 && conversions === 0) {
      issues.push({
        ...
        description: `This campaign has spent ₹${Math.round(spend).toLocaleString('en-IN')} in the last 30 days with zero recorded conversions. Your money is being spent with no return.`,
