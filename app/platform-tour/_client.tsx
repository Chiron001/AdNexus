...
const STEPS = [
  {
    ...
    body: 'Connect Meta, Google, and Amazon accounts via standard OAuth. Adnexusone never stores your platform credentials — authentication is handled directly through each platform\'s official API.',
  ...
  },
  {
    ...
    body: 'On first sync, Adnexusone runs a full 30-point diagnostic across every connected account. Issues are ranked by revenue impact — the most expensive problem is always at the top.',
  ...
  },
  {
    ...
    body: 'Pick an account, pick a date range, click generate. Adnexusone writes a full diagnostic narrative in plain English — issues, impact, and recommendations — formatted and ready to share.',
  ...
  },
  {
    ...
    body: 'After setup, Adnexusone runs in the background. Every sync re-runs all diagnostics, compares to your baselines, and surfaces new issues. Your account health score updates automatically.',
...
export default function PlatformTourPage() {
  return (
    <div className="min-h-screen text-white" style={{ background: '#070810' }}>
      ...
      {/* Header */}
      <section className="relative pt-20 sm:pt-36 pb-16 px-5 sm:px-6 overflow-hidden">
