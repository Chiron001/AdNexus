  ...
  google: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: 'GOCSPX-...',
        type: 'password' as const,
        hint: 'Paired with the OAuth Client ID above.',
      },
      {
        key: 'refresh_token',
        label: 'Refresh Token',
        ...
        type: 'password' as const,
        required: true,
        hint: 'Get this from Google OAuth Playground (see steps below). This authorises AdNexus to access your account.',
      },
    ] as FieldConfig[],
    guide: [
      { step: '1', text: 'Copy your Developer Token from Google Ads → Admin → API Center' },
      { step: '2', text: 'Copy your Customer ID from the top-right of your Google Ads dashboard' },
      { step: '3', text: 'Go to developers.google.com/oauthplayground → click ⚙️ → enable "Use your own OAuth credentials" → enter your OAuth Client ID & Secret' },
      { step: '4', text: 'In Step 1, paste https://www.googleapis.com/auth/adwords → Authorise → in Step 2 click "Exchange auth code for tokens" → copy the Refresh Token' },
    ],
    note: 'The Refresh Token is a one-time setup. It lets AdNexus sync your Google Ads data without you logging in every hour.',
  },
  amazon: {
    name: 'Amazon Ads',
    letter: 'A',
