...
export default function AIPage() {
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: '#070810' }}>
      ...
      {/* ── 1. Hero ──────────────────────────────── */}
      <section className="relative pt-20 sm:pt-40 pb-24 px-5 sm:px-6 overflow-hidden">
        {/* Background glows */}
      ...
      <section className="py-24 px-5 sm:px-6 border-t border-white/[0.05]">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Mobile: snap carousel · Desktop: side-by-side grid */}
          <div
            className="flex overflow-x-auto scrollbar-hide sm:overflow-visible sm:grid sm:grid-cols-2 sm:gap-5"
            style={{ scrollSnapType: 'x mandatory', WebkitOverflowScrolling: 'touch' } as React.CSSProperties}
          >
            {/* Add-on card */}
            <div className="flex-shrink-0 w-[88vw] sm:w-auto pr-4 sm:pr-0" style={{ scrollSnapAlign: 'start' }}>
              <div className="bg-zinc-950/60 border border-white/[0.10] rounded-2xl p-7 sm:p-8 flex flex-col h-full">
            ...
            <div className="flex-shrink-0 w-[88vw] sm:w-auto" style={{ scrollSnapAlign: 'start' }}>
              <div className="relative bg-purple-500/[0.07] border border-purple-500/40 rounded-2xl p-7 sm:p-8 flex flex-col overflow-hidden h-full">
