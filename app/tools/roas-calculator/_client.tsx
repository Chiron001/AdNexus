        ...
        <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-zinc-950/60 border border-white/[0.07] rounded-2xl p-6 sm:p-7">
            ...
            <div className="space-y-5">
              {[
                { label: 'Monthly ad spend ($)', placeholder: 'e.g. 1500', value: spend, onChange: setSpend, hint: 'Total spend across Meta, Google, Amazon' },
                { label: 'Revenue attributed ($)', placeholder: 'e.g. 4500', value: revenue, onChange: setRevenue, hint: 'Revenue attributed to the same period' },
                { label: 'Cost of goods sold ($)', placeholder: 'e.g. 1800', value: cogs, onChange: setCogs, hint: 'Product cost for the revenue above (optional)' },
